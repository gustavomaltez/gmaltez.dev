...
export default function Error404() {
  return (
    <>
      ...
      <div class='flex flex-1 lg:w-screen max-w-screen-lg h-full items-center justify-center'>
        <div class='flex flex-col items-center justify-center max-w-md'>
          <h3 class='not-found-text text-lg sm:text-xl'>
            Oops! Page not found!
          </h3>
          <h1 class='not-found-numbers text-[10rem] -my-[2.5rem] sm:text-[14rem] sm:-my-[3.5rem]'>
            <span>4</span>
            <span>0</span>
            <span>4</span>
          </h1>
