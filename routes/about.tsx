      ...
      <main className="flex flex-col justify-items-center gap-3">
        <div className="flex flex-col items-center justify-center gap-5 sm:flex-row sm:justify-start mb-3 mt-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold">
            Hello! <br className="hidden sm:block" />I'm Gustavo Maltez :)
          </h1>
        </div>
        ...
        <p className="text-text-secondary">
          ...
          Arduino and C++. Back then, I developed several projects using Arduino,
          and this sparked a new interest in me to create a mobile app for
          controlling my Arduino projects. This desire led me to learn React
        ...
        <p className="text-text-secondary">
          ...
          through innovative solutions. I believe in the transformative power
          of technology and its potential to bring about positive change, and
          I am committed to using my skills and knowledge to contribute to this vision.
        </p>
        <p className="text-text-secondary">
          ...
          primary goal is to share my experiences and expertise with fellow developers,
          empowering them to grow and excel in their journeys. Additionally, I
          see writing as an excellent means to improve my English skills, and
          this blog serves as a platform for honing my language proficiency.
