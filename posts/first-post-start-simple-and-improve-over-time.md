...
snippet: I spent 100 hours building the perfect blog with every feature I could think of, then abandoned it for a year. Here's why I scrapped everything, started over with the basics, and why that was the best decision I could've made.
...
June 25, 2023. I decided to build a blog from scratch using React and TypeScript. But I also wanted to learn something new, so I picked [Deno](https://deno.com/) and [Fresh](https://fresh.deno.dev/). Sounds reasonable, right?
